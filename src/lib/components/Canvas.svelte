...
<div id="game">
	...
	<div id="controls">
		<button onclick={() => slide('up')}>slide up</button>
		<button onclick={() => slide('left')}>slide left</button>
		<button onclick={() => slide('right')}>slide right</button>
		<button onclick={() => slide('down')}>slide down</button>
	</div>
</div>
